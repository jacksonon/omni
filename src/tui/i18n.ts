...
const ZH: Record<string, string> = {
  ...
  'status.ask': '等待你的选择（A-D 选项 / 输入自定义后 Enter）',
  'ask.hint': 'A-D 勾选 · 输入自定义内容后 Enter · Esc 取消',
  'help.title': '帮助',
...
const EN: Record<string, string> = {
  ...
  'status.ask': 'Waiting for your choice (A-D options / type custom input + Enter)',
  'ask.hint': 'A-D select · type custom input + Enter · Esc cancel',
  'help.title': 'Help',
